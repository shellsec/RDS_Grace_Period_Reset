@echo off
rem Create RDS Grace Period Reset Scheduled Task - NoReboot
...
if %time_choice%==4 set EXEC_TIME=04:00
if %time_choice%==5 set EXEC_TIME=05:00
if %time_choice%==6 set EXEC_TIME=06:00
if %time_choice%==7 (
    echo.
...
echo rem RDS Task Monitor >> "%MONITOR_SCRIPT%"
